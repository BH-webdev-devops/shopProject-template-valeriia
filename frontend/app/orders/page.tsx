            ...
            <div className="min-h-screen bg-black text-white py-8 px-4">
                <div className="space-y-6">
                    {orderData.map((order: any) => (
                        ...
                        >
                            <h1 className="text-3xl font-bold text-center mb-6">Order #{order.id}</h1>
    
                            <div className="flex justify-between items-center mb-6">
                                <div>
                                    <h2 className="text-lg font-semibold text-gray-300">Status:</h2>
                                    <p className="text-xl font-bold text-green-500">{order.status}</p>
                                </div>
                                <div className="text-right">
                                    <h2 className="text-lg font-semibold text-gray-300">Total:</h2>
                                    <p className="text-xl font-bold text-yellow-400">{order.total} €</p>
                                </div>
                            </div>
