...
const OrderDetailPage: React.FC = () => {
    ...
    return (
        <div className="container bg-black text-white mx-auto px-6 py-8">
            ...
            <h1 className="text-3xl font-bold text-center mb-6">Order #{orderData.id}</h1>
            ...
            <div className="flex justify-between mb-8">
                ...
                <div className="text-right">
                    ...
                    <p className="text-xl font-bold text-yellow-400">{orderData.total} €</p>
                </div>
            </div>
            ...
            <div className="space-y-6">
                {orderData.items.map((item: any) => (
                    <div key={item.product.id} className="bg-gray-900 rounded-lg shadow-lg p-6 max-w-full w-full">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-lg font-semibold text-gray-300">{item.product.name}</h3>
